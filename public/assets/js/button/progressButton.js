...
(function (window) {
    ...
    ProgressButton.prototype._init = function (el) {
        this._validate();
        // create structure
        this._create();
        // init events
    ...
    ProgressButton.prototype._initEvents = function (el) {
        var self = this;
        //this.button.addEventListener( 'onsubmit', function() {
